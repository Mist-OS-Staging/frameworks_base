...
import com.android.internal.util.MistUtils;
import com.android.internal.util.MistUtils.UploadResultCallback;
...
final class AppErrorDialog extends BaseErrorDialog implements View.OnClickListener {
    ...
    private void postToMistAndCopyURL() {
        // Post to Mist
        MistUtils.upload(mPaste, new UploadResultCallback() {
