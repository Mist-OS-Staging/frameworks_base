...
/**
 * Helper functions for uploading to Mist
 */
public final class MistUtils {
    ...
    private static final String API_URL = "https://raven.aosp.workers.dev";
    ...
    /**
     * Uploads {@code content} to Mist
     *
     * @param content the content to upload to Mist
                ...
                try {
                    ...
                    try {
                        ...
                        if (!key.isEmpty()) {
                            ...
                            String msg = "Failed to upload to Mist: No key retrieved";
                            callback.onFail(msg, new MistException(msg));
                        }
                    } finally {
                        urlConnection.disconnect();
                    }
                } catch (Exception e) {
                    callback.onFail("Failed to upload to Mist", e);
                }
            }
        });
    }
    ...
    private static Handler getHandler() {
        if (handler == null) {
            HandlerThread handlerThread = new HandlerThread("MistThread");
